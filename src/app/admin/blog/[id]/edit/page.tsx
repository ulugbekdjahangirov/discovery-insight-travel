    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          og_title_de: data.og_title_de || '',
          og_title_ru: data.og_title_ru || '',
          og_description_en: data.og_description_en || '',
          og_description_de: data.og_description_de || '',
          og_description_ru: data.og_description_ru || '',
        });
      } else {
      ...
      setError('Postni yuklashda xatolik');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const data = await response.json();
        setError(data.error || 'Postni yangilashda xatolik');
      }
    } catch (err) {
      console.error('Error updating post:', err);
      setError('Postni yangilashda xatolik');
    } finally {
      setIsSaving(false);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-secondary-800">Postni Tahrirlash</h1>
          <p className="text-secondary-600">Blog postni yangilang</p>
        </div>
      </div>
